  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="rounded-md border border-amber-500/30 bg-amber-500/10 px-2.5 py-1 text-xs font-semibold text-amber-400 hover:bg-amber-500/20"
      ...
      {/* 트리거 피드백 토스트 */}
      {toast && (
        <div className="fixed right-4 top-14 z-[2000] flex items-center gap-3 rounded-xl border border-gray-700 bg-gray-900 px-4 py-3 shadow-2xl">
